...
//                console.log(symbol);
                ...
                //$( "#"+symbol+"_price_usd" ).html(parseFloat(coin_obj.price_usd).toFixed(4).toLocaleString( 'de-DE' ) + " $");
                $("#" + symbol + "_price_usd").html(parseFloat(coin_obj.price_usd).toLocaleString('it-IT') + ' $');
                //console.log(parseFloat(coin_obj.price_usd).toLocaleString('it-IT'));
                ...
                $("#" + symbol + "_market_cap_usd").html(parseFloat(coin_obj.market_cap_usd).toLocaleString('it-IT') + ' $');
                $("#" + symbol + "_market_cap_usd").attr('data-value', coin_obj.market_cap_usd);
                $("#" + symbol + "_24h_volume_usd").html(parseFloat(coin_obj['24h_volume_usd']).toLocaleString('it-IT') + ' $');
