            ...
            <div class="col-md-8 text-center">
                <div class="panel panel-default">
                    ...
                    <table class="table table-striped table-bordered sortable">
                        ...
                        <tbody>                            
                            <tr>
                                <td class="text-right" >{{ number_format($total_usdt['gain_loss'],8) }} $</td>
                                <td class="text-right" >{{ number_format($total_usdt['diff_24h'],8) }} $</td>                                
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-striped table-bordered sortable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right" >{{ number_format($values['gain_loss'],8) }}</td>
                                <td class="text-right" >{{ number_format($values['diff_24h'],8) }}</td>   
                                <td class="text-right" >{{ number_format($values['gain_loss_usdt'],8) }}</td>
                                <td class="text-right" >{{ number_format($values['diff_24h_usdt'],8) }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                        ...
                        <tbody>                            
                            @foreach($markets as $market => $values)
                                <tr>
                                    ...
                                    <td class="text-right" >{{ number_format($values['gain_loss'],6) }}</td>
                                    <td class="text-right" >{{ number_format($values['diff_24h'],6) }}</td>
                                    <td class="text-right" >{{ number_format($values['fees'],6) }}</td>
                                    <td class="text-right" >{{ number_format($values['exchange_price'],6) }}</td>
                                    <td class="text-right">{{ number_format($values['price_change_percent'],3) }} %</td>
                                </tr>
                            @endforeach                
                        </tbody>
                    </table>   
