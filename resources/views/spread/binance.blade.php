        ...
        <table class="table table-striped table-bordered sortable">
          ...
          <tbody>
           ...
           ">
            ...
            @endif
            @if(isset($coin['bittrex-diff']))
            <td class="text-right" style="color:{{ $coin['bittrex-diff'] < 0 ? " red" : " green"  }} ;"> {{ number_format($coin['bittrex-diff'],8) }} </td>
            @else
            <td class="text-right" style="color: blue;"> ##### </td>
            @endif
          </tr>
        ...
        <table class="table table-striped table-bordered sortable">
          ...
          <tbody>
           ...
           <tr>
            ...
            @endif
            @if(isset($coin['bittrex-diff']))
            <td class="text-right" style="color:{{ $coin['bittrex-diff'] < 0 ? " red" : " green"  }} ;"> {{ number_format($coin['bittrex-diff'],6) }} </td>
            @else
            <td class="text-right" style="color: blue;"> ##### </td>
            @endif
          </tr>
